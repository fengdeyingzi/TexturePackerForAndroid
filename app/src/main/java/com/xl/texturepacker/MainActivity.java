...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
	...
	FileSelectView text_input,text_output;
    ...
    public void onCreate(Bundle savedInstanceState)
	{
		...
		text_input = (FileSelectView) findViewById(R.id.edit_input);
		text_output = (FileSelectView) findViewById(R.id.edit_output);
		text_input.selectDir();
		text_output.selectDir();
		text_input.setMinLeve(text_input.getLeve(FileUtils.getSDPath()));
		text_output.setMinLeve(text_input.getLeve(FileUtils.getSDPath()));
...
//				createDir();
	...
	{
		preference.setString("input",text_input.getPath().toString());
		preference.setString("output",text_output.getPath().toString());
	...
	private void look()
	{
		String input = text_input.getPath().toString();
		String output = text_output.getPath().toString();
